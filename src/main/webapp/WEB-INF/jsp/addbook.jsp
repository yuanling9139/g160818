...
<div class="w960">
    ...
    <div class="w740 right">
        ...
        <div class="order02 pb10">
            <f:form action="gly/glyadd" modelAttribute="bookType">
                <table width="738" align="center" cellpadding="0" cellspacing="0">
                    <tr class="bd2">
                        ...
                        <td width="80%"  align="left" class="bd1 pl9" >
                            <input type="text" name="bBt"class="input w300"><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                    ...
                    <tr class="bd2">
                        ...
                        <td width="80%"  align="left" class="bd1 pl9" >
                            <input type="text" name="bZz" class="input w300"><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        <th width="20%" align="center" class="bd2">价格</td>
                        <td width="80%"  align="left" class="bd1 pl9" >
                            <input type="text" name="bJg" class="input w300"><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        <th width="20%" align="center" class="bd2">出版社</td>
                        <td width="80%"  align="left" class="bd1 pl9" >
                            <input type="text" name="bCbs" class="input w300"><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        <th width="20%" align="center" class="bd2">简介</td>
                        <td width="80%"  align="left" class="bd1 pl9" rowspan="3">
                            <textarea name="bSjjj" rows="6" class="w300"></textarea><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="">
